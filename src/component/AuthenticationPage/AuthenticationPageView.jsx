...
import {AccountInfo, AuthenticationType} from "../../context/AuthenticationProvider";
      ...
      <div className="columns">
        <div className="column">
          ...
          <div className="text-center m-2">
            <button className={`btn btn-primary ${loading ? 'loading' : ''}`} onClick={e => onSubmit(AuthenticationType.AUTH_TOKEN)}>Authenticate with AuthToken</button>
          </div>
        </div>
